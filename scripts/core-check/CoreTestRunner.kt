...
fun main() {
    val classes = listOf(
        ...
        com.darius.unison.playback.DesiredPlaybackStateTest::class.java,
        ...
        com.darius.unison.playback.PlayerItemTransitionPolicyTest::class.java,
        com.darius.unison.playback.PlayerTransitionCircuitBreakerTest::class.java,
        ...
        com.darius.unison.room.PendingTrackTransitionRegistryTest::class.java,
        ...
        com.darius.unison.playback.PlayerMutationCoordinatorTest::class.java,
        com.darius.unison.playback.ScheduledPlaybackControllerTest::class.java,
