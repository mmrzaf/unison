...
> **Public beta:** `1.2.0-beta.4` is the current 1.2 production-style beta. It uses the same signed
...
- Version: `1.2.0-beta.4` (`versionCode` 7)
...
as `v1.2.0-beta.4`; a release build does not imply a stable release.
