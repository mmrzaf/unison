...
## 1.2.0-beta.7 qualification

The Beta 7 implementation baseline is feature-frozen. Remaining work is release qualification:
...
- record accepted known issues, reviewer/date, and final disposition in
  `docs/release-evidence/1.2.0-beta.7.md`.

No new product feature or broad architecture refactor should enter Beta 7 while those gates are open.

## 1.2 stable

- No open correctness, security, state-authority, storage-integrity, or release-signing blockers.
- Beta 7-and-later supported local data survives upgrades to the stable build.
